...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="tenantBDashboard.php">
            ...
            <li class=" nav-item"><a href="#"><i class="feather icon-users"></i><span class="menu-title" data-i18n="User Management">Task Management</span></a>
                <ul class="menu-content">
                    <li class="<?php echo basename($_SERVER['PHP_SELF']) == 'Create-User-list.php' ? 'active' : ''; ?>">
                        <a href="tenantB-users.php"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Creation of Users">Users List</span></a>
                    </li>
                    <li class="<?php echo basename($_SERVER['PHP_SELF']) == 'Client-Manager.php' ? 'active' : ''; ?>"><a href="tenantB_tasks.php"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Roles and Responsibilities">Task List</span></a>
                    </li>
                </ul>
            </li>
            <?php  ?>
